...
print("\033[31mPY\033[0m \033[33mOS\033[0m \033[34mImproved\033[0m | Version 1.0(Beta 2-Hotfix 1 | Build 30)")
            ...
            if passwd == stpasswd:
                ...
                while count < 3:
                    ...
                    if cmd == "ls": # Path
                        ...
                        print(color.purple + "      --- Improved ---       " + color.reset)
                        time.sleep(0.1)
                        print("System:PY OS Improved 1.0 b2-hf1 b30")
                        time.sleep(0.1)
                        ...
                        print("---------------| About |---------------")
                        print(color.blue + "PY OS Improved 1.0 b2-Hotfix 1(Build 30)" + color.reset)
