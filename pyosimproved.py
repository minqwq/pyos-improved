...
def dialog():
    ...
    time.sleep(0.1)
    print(color.green + "PY OS Improved " +
        system_version + " /unk /stack /uwu" + color.reset)
    time.sleep(1)
    os.system("clear")
    time.sleep(0.1)
...
def system_start():
    ...
    print(colorama.Fore.BLACK + colorama.Back.LIGHTBLUE_EX +
        "      |---==Improved==---|      " + color.reset)
    print(" ")
    print(random.sample(pyosimprovedtips, 1))
    print(" ")
    print("\033[38;5;45m" + "PY " + "\033[38;5;81m" + "OS " + "\033[38;5;117m" + "Im" + "\033[38;5;153m" + "pr" +
        "\033[38;5;189m" + "ov" + "\033[38;5;225m" + "ed" + color.reset + " | " + system_version + " | " + system_build)
    ...
    print(colorama.Fore.LIGHTCYAN_EX +
        "Feel free to improve PY OS Improved!" + color.reset)
    print(" ")
    ...
    pygame.mixer.music.play()
    # Login screen | For restart to login manager, please goto this line for work normally
    print(colorama.Fore.LIGHTCYAN_EX +
        "Hewwwo wewcome back to PY OS Improved senpai >.<" + color.reset)
    print(colorama.Fore.LIGHTGREEN_EX + "Leave blank for shutdown" + color.reset)
    now = datetime.datetime.now()
    other_StyleTime = now.strftime("%b %a %d %H:%M:%S %Y")
    print("Current time: " + colorama.Fore.LIGHTCYAN_EX +
        other_StyleTime + color.reset)
